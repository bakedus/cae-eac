...
1. SQL Server Management Studio or another tool such as Power BI Desktop. (These tools are available by default in the Data Science Virtual Machine images.)
